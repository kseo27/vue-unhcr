/* C3.js Extensions - 2021-09-12 _kseo */
(function(factory) {
	if ( typeof window !== 'undefined' && window.c3 ) {
		// Browser globals
		factory(c3);
	}
}(function (c3) { 'use strict';
...
var c3x = c3.chart.internal.fn;

c3x.beforeInit = function(e) {
	console.log(this,e);
}

// Set Defaults
c3x.additionalConfig = {
	...
	// axis_y_inner: undefined,
	// axis_y_label: {},
	axis_y_tick_format: d3.format('.2f'),
	axis_y_tick_outer: false,
	// axis_y_tick_values: null,
	// axis_y_tick_rotate: 0,
	// axis_y_tick_count: undefined,
	// axis_y_tick_time_type: undefined,
